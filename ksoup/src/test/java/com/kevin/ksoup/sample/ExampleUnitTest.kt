...
class ExampleUnitTest {
    ...
    fun setup() {
        ...
        tropesArticle = Paths.get(testFolder, "article.html").toFile().readText()
    }

    @Test
    fun home_works() {
        val k = Ksoup()
        val article = k.parse(cookingArticle!!, HomeEntity::class.java)
    ...
    fun tropes_works() {
        val k = Ksoup()
        val article = k.parse<ParsedArticle>(tropesArticle!!)
